...
exports.default = _default;
        var $1fd059 = exports.default || module.exports;
      
      if (typeof $1fd059 === 'function') {
        $1fd059 = $1fd059.options;
      }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$1fd059', $1fd059);
          } else {
            api.reload('$1fd059', $1fd059);
          }
        }
  ...
  created: function created() {
    ...
    if (this.allowed && this.allowed.length > 0) {
      Object.keys(this.$options.blocks).forEach(function (type) {
        if (_this2.allowed.includes(type) === false) {
          delete _this2.$options.blocks[type];
        }
      });
    }
                  ...
                  [
                    _vm.focused === index
                      ? _c("k-editor-options", {
                          ...
                          refInFor: true,
                          attrs: {
                            blocks: _vm.$options.blocks,
                            block: _vm.$options.blocks[block.type],
                            menu: _vm.menu
                          },
                          on: {
                            add: function($event) {
                    ...
                    _c(
                      ...
                      _vm._b(
                        ...
                        "component",
                        _vm.$options.blocks[block.type].bind,
                        false
                      )
                    )
                  ],
